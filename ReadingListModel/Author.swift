...
open class Author: ModelObject
{
    public struct Keys {
       ...
       // this allows me to say Author.Keys.  in order to see all the keys in this model
        // the Author.Keys.all to get all the keys back, (the keys are basically identical
